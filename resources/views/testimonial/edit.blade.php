    ...
    <form action="{{route('testimonial.update',$testimonial)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="text-center form-group container">    
           ...
           <div class="form-group">
               ...
               <input class="form-control" type="text" name='full_name' value="{{old('full_name',$testimonial->full_name)}}">
               @error('full_name')
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="file" name='img' value="{{old('img',$testimonial->img)}}">
                @error('img')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name='role' value="{{old('role',$testimonial->role)}}">
                @error('role')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div> 
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name='company' value="{{old('company',$testimonial->company)}}">
                @error('company')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div> 
            ...
            <div class="form-group">
                <label class="d-block input-group-text" for="text">text</label>
                <input class="form-control" type="text" name='text' value="{{old('text',$testimonial->text)}}">
                @error('text')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div> 
