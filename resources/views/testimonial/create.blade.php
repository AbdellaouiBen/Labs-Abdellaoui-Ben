    ...
    <form action="{{route('testimonial.store')}}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="text-center form-group container">    
            <div class="form-group">
                ...
                <input class="form-control" placeholder="Nom complet du client" type="full_name " name='full_name' value="@if($errors->first('full_name'))@else{{ old('full_name') }}@endif">      
                @error('full_name')
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="Fonction du client" type="role " name='role' value="@if($errors->first('role'))@else{{ old('role') }}@endif">      
                @error('role')
                <div class="alert alert-danger">{{ $message }}</div> 
                @enderror   
            </div>     
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="company" type="company " name='company' value="@if($errors->first('company'))@else{{ old('company') }}@endif">      
                @error('company')
                <div class="alert alert-danger">{{ $message }}</div> 
                @enderror   
            </div>     
